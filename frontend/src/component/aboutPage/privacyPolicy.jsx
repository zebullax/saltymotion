  ...
  <Grid container spacing={1}>
    <Grid item xs={12}>
      <Typography variant="h3" style={{ paddingBottom: 16 }}>
        Privacy Policy for Saltymotion
      </Typography>
      <Typography variant="body2">
        At Saltymotion, accessible from https://saltymotion.com, one of our main priorities is the privacy of our
        visitors. This Privacy Policy document contains types of information that is collected and recorded by
        Saltymotion and how we use it. If you have additional questions or require more information about our Privacy
        Policy, do not hesitate to contact us. This Privacy Policy applies only to our online activities and is valid
        for visitors to our website with regards to the information that they shared and/or collect in Saltymotion. This
    ...
    <Grid item xs={12}>
      ...
      <List>
        <ListItemText inset primary="Provide, operate, and maintain our website" />
        <ListItemText inset primary="Improve, personalize, and expand our website" />
        <ListItemText inset primary="Understand and analyze how you use our website" />
        <ListItemText inset primary="Develop new products, services, features, and functionality" />
        <ListItemText
          inset
          primary="Communicate with you, either directly or through one of our partners, including for customer service, to provide you with updates and other information relating to the website, and for marketing and promotional purposes"
        />
        <ListItemText inset primary="Send you emails" />
        <ListItemText inset primary="Find and prevent fraud" />
      </List>
    </Grid>
    <Grid item xs={12}>
      <Typography variant="h6">Log Files</Typography>
      <Typography variant="body2">
        Saltymotion follows a standard procedure of using log files. These files log visitors when they visit websites.
    ...
    <Grid item xs={12}>
      ...
      <Typography variant="body2">
        Like any other website, Saltymotion uses 'cookies'. These cookies are used to store information including
        ...
        and/or other information. For more general information on cookies, please read{" "}
        <a href="https://www.cookieconsent.com/what-are-cookies/">"What Are Cookies"</a>.
      </Typography>
    </Grid>
    <Grid item xs={12}>
      <Typography variant="h6">Advertising Partners Privacy Policies</Typography>
      <Typography variant="body2">
        You may consult this list to find the Privacy Policy for each of the advertising partners of Saltymotion.
        Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used
        in their respective advertisements and links that appear on Saltymotion, which are sent directly to users'
        ...
        websites that you visit. Note that Saltymotion has no access to or control over these cookies that are used by
    ...
    <Grid item xs={12}>
      ...
      <Typography variant="body2">
        Saltymotion's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
        ...
        cookies through your individual browser options. To know more detailed information about cookie management with
        specific web browsers, it can be found at the browsers' respective websites.
      </Typography>
    </Grid>
    <Grid item xs={12}>
      <Typography variant="h6">CCPA Privacy Rights (Do Not Sell My Personal Information)</Typography>
      <Typography variant="body2">
        Under the CCPA, among other rights, California consumers have the right to: Request that a business that
        collects a consumers personal data disclose the categories and specific pieces of personal data that a business
    ...
    <Grid item xs={12}>
      ...
      <Typography variant="body2">
        ...
        and guardians to observe, participate in, and/or monitor and guide their online activity. Saltymotion does not
        knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that
